package com.exam.system.controller.admin;
...
import com.exam.system.utility.*;
...
import com.exam.system.viewmodel.admin.question.QuestionResponseVM;
    ...
    private RestResponse validQuestionEditRequestVM(QuestionEditRequestVM model) {
        ...
        if (qType == QuestionTypeEnum.GapFilling.getCode()) {
            ...
            if (!fillSumScore.equals(questionScore)) {
                String errorMsg = ErrorUtil.parameterErrorFormat("score", "空分数和与题目总分不相�?);
                return new RestResponse<>(SystemCode.ParameterValidError.getCode(), errorMsg);
            }
        }
        return RestResponse.ok();
