...
import com.exam.system.event.CalculateExamPaperAnswerCompleteEvent;
import com.exam.system.event.UserEvent;
...
import com.exam.system.viewmodel.student.exam.ExamPaperReadVM;
import com.exam.system.viewmodel.student.exam.ExamPaperSubmitVM;
import com.exam.system.viewmodel.student.exampaper.ExamPaperAnswerPageResponseVM;
...
public class ExamPaperAnswerController extends BaseApiController {
    ...
    public RestResponse answerSubmit(@RequestBody @Valid ExamPaperSubmitVM examPaperSubmitVM) {
        ...
        if (null == examPaperAnswerInfo) {
            return RestResponse.fail(2, "试卷不能重复�?);
        }
    ...
    public RestResponse edit(@RequestBody @Valid ExamPaperSubmitVM examPaperSubmitVM) {
        ...
        if (examPaperAnswerStatusEnum == ExamPaperAnswerStatusEnum.Complete) {
            return RestResponse.fail(3, "试卷已完�?);
        }
